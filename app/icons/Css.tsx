...
const Css: React.FC<{width?:number}> = ({width=36}) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width={width} version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 512 512"  xmlSpace="preserve">
